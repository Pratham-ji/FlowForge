...
mapAppError e = case e of
  ...
  NotAMember _ ->
    jsonError err403 "FORBIDDEN" "You do not have permission to access this organization."
  WorkflowNotFound _ ->
  ...
  BusinessRuleViolation msg ->
    jsonError err409 "BUSINESS_RULE_VIOLATION" (T.pack msg)
